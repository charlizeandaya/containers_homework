...
class Node():
    ...
    Given a node t, you can visualize the node by running str(t) in
...
class BinaryTree():
    ...
    def print_tree(self, traversal_type):
        ...
        if traversal_type == 'preorder':
            ...
            raise ValueError(f'Traversal type {traversal_type} not supported.')
    ...
    def to_list(self, traversal_type):
        ...
        A general programming principle is that a function should return
        its results
        ...
        them.
        But by returning the results we can also do more computations
        ...
        num_list = []
        if traversal_type == 'preorder':
            return self.preorder(self.root, num_list)
        elif traversal_type == 'inorder':
            return self.inorder(self.root, num_list)
        elif traversal_type == 'postorder':
            return self.postorder(self.root, num_list)
        else:
            raise ValueError(f'Traversal type {traversal_type} not supported.')
    ...
    @staticmethod
    def __len__helper(node, counter=0):
        '''
        FIXME:
        ...
        if node.right:
            counter = BinaryTree.__len__helper(node.right, counter)
        return counter

    def height(self):
        '''
        Returns the height of the tree.
        Recall that the height is the maximum length from the root to
        a leaf node.
